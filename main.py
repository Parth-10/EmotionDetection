...
def login_validation():
    try:
        ...
        if _email and _password:
            cursor.execute(
                'SELECT * FROM usermaster WHERE email = % s AND password = % s', (_email, _password))
...
def UploadAudioFile():
    ...
    f.save('D:\\BE_PROJECT\\Speech-Emotion-Recognition-main\\SER\\uploaded_voice\\recording.wav')
    data, sampling_rate = librosa.load(
        'D:\\BE_PROJECT\\Speech-Emotion-Recognition-main\\SER\\uploaded_voice\\recording.wav')
    ...
    X, sample_rate = librosa.load('D:\\BE_PROJECT\\Speech-Emotion-Recognition-main\\SER\\uploaded_voice\\recording.wav',
